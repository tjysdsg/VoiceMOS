...
if len(gathered) != 540:
    print("*** ERROR *** There should be 540 files in the 'gathered' directory but there are " + str(len(gathered)) + '.  Did you run step 04?  Did it show any errors?  Please address any errors in the previous steps and then re-run this script.\n')
    exit()
...
if len(ds) != 540:
    print("*** ERROR *** There should be 540 files in the 'downsampled' directory but there are " + str(len(ds)) + '.  Please address any errors in the previous step and then re-run this script.\n')
    exit()
...
if missing_count > 0:
    ...
    print('All data is present, you\'re all set for the test phase OOD track of the challenge!  Good luck!')
